...
namespace R54IN0.Test
{
    ...
    public class IOStockWrapperViewModelTest
    {
        ...
        public void SyncFinder()
        {
            ...
            FinderNode node = fvm.Root.SelectMany(x => x.Descendants().Where(y => y.Type == NodeType.ITEM && y.ItemUUID == itemw.UUID)).Single();
            ...
            FinderNode node2 = fvm.Root.SelectMany(x => x.Descendants().Where(y => y.Type == NodeType.ITEM && y.ItemUUID == itemw.UUID)).Single();
