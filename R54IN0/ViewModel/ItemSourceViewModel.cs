...
namespace R54IN0
{
    public abstract class ItemSourceViewModel<T> : ViewModelObserver<T>, IItemSourceViewModel<T> where T : class
    {
        T _selectedItem;

        public ItemSourceViewModel(ViewModelObserverSubject subject) : base(subject)
        {
